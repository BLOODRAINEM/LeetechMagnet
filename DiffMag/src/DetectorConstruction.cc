...
myfile.open("gun.mac");
   ...
   G4ThreeVector targetDirection=GetTargetFaceCenter0-G4ThreeVector(0, 0, _targetThickness/2) - BeamPipeCenter0;
		myfile  <<std::setw(14)<<"/gun/position "<<std::setw(8)<< BeamPipeCenter0.x()<<" "<<std::setw(8)<<BeamPipeCenter0.y()<<" "<<std::setw(8)
		 <<BeamPipeCenter0.z()<<std::setw(8)
		 <<" mm"<<std::setw(8)
		 <<" "<<std::endl;
		 myfile  <<std::setw(14)<<"/gun/direction "<<std::setw(8)<< targetDirection.x()<<" "<<std::setw(8)<<targetDirection.y()<<" "<<std::setw(8)
